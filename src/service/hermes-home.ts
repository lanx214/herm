...
export const ENV_CATALOG: ReadonlyArray<{ category: string; keys: string[] }> = [
  {
    ...
    keys: [
      ...
      "TOGETHER_API_KEY", "XAI_API_KEY", "ZAI_API_KEY", "Z_AI_API_KEY",
    ],
  },
  {
  ...
  },
  {
    category: "Agent",
    keys: [
      "API_SERVER_KEY", "HERMES_LANGFUSE_BASE_URL", "HERMES_LANGFUSE_PUBLIC_KEY",
      "HERMES_LANGFUSE_SECRET_KEY", "MEM0_API_KEY",
    ],
  },
];
