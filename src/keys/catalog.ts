...
export const DEFAULTS = {
  ...
  "sessions.folder":   def("ctrl+f",               "Set folder",                         "sessions"),
  "sessions.folderPrev": def("[",                    "Previous folder filter",             "sessions"),
  "sessions.folderNext": def("]",                    "Next folder filter",                 "sessions"),
